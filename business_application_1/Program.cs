...
namespace signl_ogin
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<customer> customer_cdata = new List<customer>();
            List<customer> customer_bdata = new List<customer>();
            int owner_index = 0;
            string opc;
            //filename
                ...
                if (option == 1)
                {
                    ...
                    else if(user.isCustomer())
                    {
                        ...
                        do
                        {
                            ...
                            {
                                Console.Clear();
                                add_to_cart(customer_cdata,owner_data);
                                
                            }
                            else if (op1 == "2")
                            {
                                Console.Clear();
                                buy_customer(customer_cdata,customer_bdata);
                                
                            }
                            else if (op1 == "3")
                            {
                                Console.Clear();
                                show_customer(owner_data,customer_bdata);
